      ...
      toast((t) => (
        <div className="flex flex-col gap-3">
          <p className="font-bold text-sm">
            <span className="font-black">"{userName}"</span>-কে Admin বানাবেন?
          </p>
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 py-2 bg-amber-500 hover:bg-amber-400 text-white text-xs font-black rounded-xl"
            >
              হ্যাঁ, করুন
            </button>
